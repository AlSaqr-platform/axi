...
ax1.plot(data0r[:,0], data0r[:,6],'--o', color='blue', label='AR Master 0. Num tests %d, B %d' %(len(data0r[:,0]), data0r[0,4]) )
ax1.plot(data1r[:,0], data1r[:,6],'--x', color='black', label='AR Master 1. Num tests %d, B %d' %(len(data1r[:,0]), data1r[0,4]) )
